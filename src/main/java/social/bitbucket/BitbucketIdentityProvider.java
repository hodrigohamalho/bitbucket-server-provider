...
public class BitbucketIdentityProvider extends AbstractOAuth2IdentityProvider implements SocialIdentityProvider {
	...
	public static final String REALM = "redhat";
	public static final String BASE_URL = "https://sso-telecom.apps.cluster-latam-2fcf.latam-2fcf.example.opentlc.com/auth/realms/"+REALM+"/protocol/openid-connect";
	public static final String AUTH_URL = BASE_URL + "/auth";
	public static final String TOKEN_URL = BASE_URL + "/token";
	public static final String USER_URL = BASE_URL + "/userinfo";
